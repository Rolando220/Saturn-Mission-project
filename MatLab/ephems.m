...
%Saturn
sat_values=[9.53667594,-0.00125060, 0.05386179,-0.00050991,2.48599187,0.00193609,49.95424423,1222.49362201,92.59887831,-0.41897216,113.66242448,-0.28867794];
saturn0=dictionary(elements,sat_values );

% Create a dictionary with all these dictionaries
planets_ephem0_dict = dictionary('mercury', mercury0, 'venus', venus0, 'earth', earth0, 'mars', mars0, 'jupiter', jupiter0,'saturn',saturn0);
