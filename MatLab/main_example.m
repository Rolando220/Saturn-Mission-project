...
%fatto da noi
[~, r_earth_fb, v_earth_fb] = planet_orbit_coplanar(planets_elements.earth, jd_start, jd_mars_fb, jd_vec);
r_earth_fb_end = r_earth_fb(:, end);
r_earth_fb_end_1 = r_earth_fb(:,1);
...
%[r_ecl, v_ecl] = eci_eq2ecl(r_eq, v_eq); l'abbiamo commentato noi
