function plot_mars_soi(t_vec, r_sat, soi_mars, v_mars)
...
% Marte
[xs, ys, zs] = sphere(48);
surf(R_mars*xs, R_mars*ys, R_mars*zs, 'FaceColor',[1 0.6 0.4],'EdgeColor','none','FaceAlpha',0.9);
% SOI wireframe
[XS,YS,ZS] = sphere(36);
...
plot(R_mars*cos(theta), R_mars*sin(theta), 'Color',[1 0.6 0.4], 'LineWidth', 1.5);
